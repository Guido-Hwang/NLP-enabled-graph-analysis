...
from graphsage.utils import unsupervised_load_data
...
def main(argv=None):
    ...
    flags.DEFINE_integer('max_total_steps', 2000, "Maximum total number of iterations")
    flags.DEFINE_integer('validate_iter', 100, "how often to run a validation minibatch.")
    train_data = unsupervised_load_data(FLAGS.train_prefix, load_walks=True)
